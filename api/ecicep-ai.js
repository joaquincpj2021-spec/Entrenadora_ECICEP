...
const APS_CHILE_MATRIX_CONTEXT = `MATRIZ TÉCNICA ECICEP APS CHILE v4.9 (uso interno):
...
- Configuración v4.9: usar Momento ECICEP + profesión/rol + foco clínico-programático + dificultad. No usar 'ámbito de práctica' como selector separado.
...
Devuelve JSON:
{
 ...
 "caso_corregido":"texto breve, humano, institucional, anonimizado, clínicamente seguro, no culpabilizante, estructurado en 3 a 5 párrafos breves y listo para practicar",
