...
## Cambios v4.9 — Consolidación clínica, visual y técnica
...
## Cambios v4.9
- Limpia la pantalla “Lee el caso simulado”: solo muestra el caso y botones principales.
- Oculta mensajes técnicos: validación, sanitización, control duro local, lectura rápida y lectura técnica.
- Agrega `normalizeCaseStyle()` para reescritura local final.
- Agrega `caseStyleCheck()` para detectar estilo poco formal antes de mostrar.
- Refuerza API para reescribir en estilo clínico-formativo cuando se detecta redacción débil.
