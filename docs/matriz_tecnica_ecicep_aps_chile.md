# Matriz técnica ECICEP APS Chile v4.9
...
## Cambio v4.9: configuración corregida
...
## Cambio v4.9: práctica con IA simplificada
...
## Cambio v4.9: control de calidad de casos
...
## Cambio v4.9: entrevista con síntesis viva
...
## Cambio v4.9: validación dura local y sanitización
...
## Cambio v4.9: síntesis viva coloreada y trazable
...
## Cambio v4.9: limpieza visual y normalización final del caso

La pantalla “Lee el caso simulado” muestra solo:

- título;
- instrucción breve;
- caso simulado;
- botones Volver y Comenzar entrevista.

Las validaciones, lectura rápida, control duro local y lectura técnica quedan ocultas como lógica interna.

Además, antes de mostrar el caso se aplica una normalización final de estilo para evitar textos como “Persona, una mujer…”, lenguaje culpabilizante o frases clínicas vagas.
